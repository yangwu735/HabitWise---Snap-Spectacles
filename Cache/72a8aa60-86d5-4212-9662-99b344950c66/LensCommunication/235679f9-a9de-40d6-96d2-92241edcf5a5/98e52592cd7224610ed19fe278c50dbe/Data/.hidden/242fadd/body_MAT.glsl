...
Opacity=0.0;
UnlitColor=vec4(0.0);
vec4 l9_0=BaseColorFactor;
vec2 l9_1=BaseTextureOffset;
vec2 l9_2=BaseTextureScale;
float l9_3=BaseTextureRotation;
vec4 l9_4;
#if (ENABLE_BASE_TEX)
{
vec2 l9_5=N35_getUV(NODE_7_DROPLIST_ITEM);
vec2 l9_6;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_BASE_TEXTURE_TRANSFORM)
{
l9_6=N35_uvTransform(l9_5,l9_1,l9_2,l9_3);
}
#else
{
l9_6=l9_5;
...
#endif
l9_4=l9_0*ssSRGB_to_Linear(N35_BaseTexture_sample(l9_6));
}
#else
{
l9_4=l9_0;
...
#if (ENABLE_VERTEX_COLOR_BASE)
{
l9_7=l9_4*tempGlobals.VertexColor;
}
#else
{
l9_7=l9_4;
...
BaseColor=l9_7.xyz;
Opacity=l9_7.w;
UnlitColor=ssLinear_to_SRGB(l9_7);
}
...
{
l9_0=texture2DLodEXT(texsmp,uv,level_);
}
#else
{
vec4 l9_1;
...
#endif
l9_1=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_2,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_3;
...
{
l9_3=sc_SampleView(sc_EnvmapDiffuseDims.xy,calcSeamlessPanoramicUvsForSampling(l9_0,sc_EnvmapDiffuseSize.xy,0.0),sc_EnvmapDiffuseLayout,sc_EnvmapDiffuseGetStereoViewIndex(),-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_3=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_0,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_1=l9_3;
}
...
#else
{
l9_0=sc_SampleView(sc_ScreenTextureDims.xy,sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw),sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex(),0.0,sc_ScreenTexture);
}
#endif
vec4 l9_1;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_5=N3_getUV(NODE_10_DROPLIST_ITEM);
vec2 l9_6;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_EMISSIVE_TEXTURE_TRANSFORM)
{
l9_6=N3_uvTransform(l9_5,emissiveTexture_offset,emissiveTexture_scale,emissiveTexture_rotation);
}
#else
{
l9_6=l9_5;
...
#endif
l9_4=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(emissiveTextureDims.xy,emissiveTextureLayout,l9_7,l9_6,(int(SC_USE_UV_TRANSFORM_emissiveTexture)!=0),emissiveTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTexture,SC_SOFTWARE_WRAP_MODE_V_emissiveTexture),(int(SC_USE_UV_MIN_MAX_emissiveTexture)!=0),emissiveTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_emissiveTexture)!=0),emissiveTextureBorderColor,0.0,emissiveTexture).xyz)*ssSRGB_to_Linear(emissiveFactor);
}
#else
{
l9_4=emissiveFactor;
...
#endif
vec3 l9_8=tempGlobals.VertexNormal_WorldSpace;
vec3 l9_9=normalize(l9_8);
vec3 l9_10;
#if (ENABLE_NORMALMAP)
{
vec2 l9_11=N3_getUV(NODE_8_DROPLIST_ITEM);
vec2 l9_12;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_NORMAL_TEXTURE_TRANSFORM)
{
l9_12=N3_uvTransform(l9_11,normalTexture_offset,normalTexture_scale,normalTexture_rotation);
}
#else
{
l9_12=l9_11;
...
#endif
l9_10=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,l9_9)*mix(vec3(0.0,0.0,1.0),(sc_SampleTextureBiasOrLevel(normalTextureDims.xy,normalTextureLayout,l9_13,l9_12,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture),(int(SC_USE_UV_MIN_MAX_normalTexture)!=0),normalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0),normalTextureBorderColor,0.0,normalTexture).xyz*1.9921875)-vec3(1.0),vec3(l9_0)));
}
#else
{
l9_10=l9_9;
...
#if (ENABLE_METALLIC_ROUGHNESS_TEX)
{
vec2 l9_17=N3_getUV(NODE_11_DROPLIST_ITEM);
vec2 l9_18;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_METALLIC_ROUGHNESS_TEXTURE_TRANSFORM)
{
l9_18=N3_uvTransform(l9_17,metallicRoughnessTexture_offset,metallicRoughnessTexture_scale,metallicRoughnessTexture_rotation);
}
#else
{
l9_18=l9_17;
...
#endif
vec4 l9_20=sc_SampleTextureBiasOrLevel(metallicRoughnessTextureDims.xy,metallicRoughnessTextureLayout,l9_19,l9_18,(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture)!=0),metallicRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture),(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture)!=0),metallicRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0),metallicRoughnessTextureBorderColor,0.0,metallicRoughnessTexture);
vec4 l9_21=vec4(0.0);
l9_21.w=l9_1;
vec3 l9_22=vec3(1.0+(l9_1*(l9_20.z-1.0)));
l9_16=roughnessFactor*l9_20.y;
l9_15=vec4(l9_22.x,l9_22.y,l9_22.z,l9_21.w);
l9_14=metallicFactor*l9_20.x;
}
#else
{
l9_16=roughnessFactor;
l9_15=vec4(1.0,1.0,1.0,0.0);
l9_14=metallicFactor;
}
#endif
vec3 l9_23;
vec3 l9_24;
...
{
vec2 l9_26=tempGlobals.gScreenCoord;
int l9_27;
...
#endif
vec3 l9_28=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(screenTextureDims.xy,screenTextureLayout,l9_27,l9_26,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture),(int(SC_USE_UV_MIN_MAX_screenTexture)!=0),screenTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0),screenTextureBorderColor,0.0,screenTexture).xyz);
float l9_29;
#if (ENABLE_TRANSMISSION_TEX)
{
vec2 l9_30=N3_getUV(Tweak_N30);
vec2 l9_31;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_TRANSMISSION_TEXTURE_TRANSFORM)
{
l9_31=N3_uvTransform(l9_30,transmissionTexture_offset,transmissionTexture_scale,transmissionTexture_rotation);
}
#else
{
l9_31=l9_30;
...
#endif
vec3 l9_33=vec3(l9_29*transmissionFactor);
vec3 l9_34=vec3(l9_14);
l9_25=l9_28;
l9_24=mix(mix(vec3(0.0),l9_2,l9_33)*l9_28,vec3(0.0),l9_34)+l9_4;
l9_23=mix(mix(l9_2,vec3(0.0),l9_33),l9_2,l9_34);
}
#else
{
l9_25=vec3(0.0);
...
#endif
vec3 l9_35=ssLinear_to_SRGB(l9_23);
float l9_36;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_36=pow(l9_3,0.45454544);
}
#else
{
l9_36=sqrt(l9_3);
...
#endif
vec3 l9_37=ssLinear_to_SRGB(l9_24);
vec4 l9_38;
#if (ENABLE_SHEEN)
{
vec3 l9_39;
...
{
vec2 l9_40=N3_getUV(Tweak_N32);
vec2 l9_41;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_SHEEN_COLOR_TEXTURE_TRANSFORM)
{
l9_41=N3_uvTransform(l9_40,sheenColorTexture_offset,sheenColorTexture_scale,sheenColorTexture_rotation);
}
#else
{
l9_41=l9_40;
...
#endif
l9_39=sheenColorFactor*ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(sheenColorTextureDims.xy,sheenColorTextureLayout,l9_42,l9_41,(int(SC_USE_UV_TRANSFORM_sheenColorTexture)!=0),sheenColorTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture),(int(SC_USE_UV_MIN_MAX_sheenColorTexture)!=0),sheenColorTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0),sheenColorTextureBorderColor,0.0,sheenColorTexture).xyz);
}
#else
{
l9_39=sheenColorFactor;
}
#endif
float l9_43;
#if (ENABLE_SHEEN_ROUGHNESS_TEX)
{
vec2 l9_44=N3_getUV(Tweak_N37);
vec2 l9_45;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_SHEEN_ROUGHNESS_TEXTURE_TRANSFORM)
{
l9_45=N3_uvTransform(l9_44,sheenRoughnessTexture_offset,sheenRoughnessTexture_scale,sheenRoughnessTexture_rotation);
}
#else
{
l9_45=l9_44;
...
#endif
float l9_47=max(l9_43,9.9999997e-05);
vec3 l9_48=tempGlobals.SurfacePosition_WorldSpace;
vec3 l9_49=normalize(sc_Camera.position-l9_48);
float l9_50=dot(l9_10,l9_49);
float l9_51=max(clamp(l9_50,0.0,1.0),9.9999997e-05);
float l9_52=l9_47*l9_47;
vec3 l9_53=reflect(-l9_49,l9_10);
bool l9_54=l9_47<0.25;
float l9_55;
if (l9_54)
{
l9_55=(((-339.20001)*l9_52)+(161.39999*l9_47))-25.9;
}
else
{
l9_55=(((-8.4799995)*l9_52)+(14.3*l9_47))-9.9499998;
}
float l9_56;
if (l9_54)
{
l9_56=((44.0*l9_52)-(23.700001*l9_47))+3.26;
}
else
{
l9_56=((1.97*l9_52)-(3.27*l9_47))+0.72000003;
}
float l9_57=l9_55*l9_51;
float l9_58=l9_57+l9_56;
float l9_59;
if (l9_54)
{
l9_59=0.0;
...
{
l9_59=0.1*(l9_47-0.25);
}
float l9_60=exp(l9_58)+l9_59;
vec3 l9_61=sampleSpecularEnvTextureLod(normalize(l9_53),3.0+((((l9_47*4.0)-0.0)*2.0)/5.0));
vec3 l9_62=(l9_61*sc_EnvmapExposure)*l9_39;
vec3 l9_63=(vec3(0.0)+(l9_62*clamp(l9_60*3.1415927,0.0,1.0))).xyz;
vec3 l9_64;
#if (sc_DirectionalLightsCount>0)
{
vec3 l9_65;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_68=l9_67<sc_DirectionalLightsCount;
if (l9_68)
{
vec3 l9_69;
if (l9_68)
{
l9_69=sc_DirectionalLights[l9_67].color.xyz;
}
else
{
l9_69=vec3(0.0);
...
if (l9_68)
{
l9_70=sc_DirectionalLights[l9_67].color.w;
}
else
{
l9_70=0.0;
}
vec3 l9_71=l9_69*l9_70;
vec3 l9_72;
if (l9_68)
{
l9_72=-sc_DirectionalLights[l9_67].direction;
}
else
{
l9_72=vec3(0.0);
...
float l9_74=clamp(dot(l9_10,l9_73),0.0,1.0);
l9_66=l9_65+(((((l9_71*3.1415901)*l9_39)*N3_charlieD(l9_52,clamp(dot(l9_10,normalize(l9_73+l9_49)),0.0,1.0)))*(1.0/(4.0*((l9_74+l9_51)-(l9_74*l9_51)))))*l9_74);
l9_65=l9_66;
l9_67++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_79=l9_78<sc_PointLightsCount;
if (l9_79)
{
vec3 l9_80;
if (l9_79)
{
l9_80=sc_PointLights[l9_78].color.xyz;
}
else
{
l9_80=vec3(0.0);
...
if (l9_79)
{
l9_81=sc_PointLights[l9_78].color.w;
}
else
{
l9_81=0.0;
}
vec3 l9_82=l9_80*l9_81;
vec3 l9_83;
if (l9_79)
{
l9_83=sc_PointLights[l9_78].position;
}
else
{
l9_83=vec3(0.0);
}
vec3 l9_84=normalize(l9_83-tempGlobals.SurfacePosition_WorldSpace);
float l9_85=clamp(dot(l9_10,l9_84),0.0,1.0);
l9_77=l9_76+(((((l9_82*3.1415901)*l9_39)*N3_charlieD(l9_52,clamp(dot(l9_10,normalize(l9_84+l9_49)),0.0,1.0)))*(1.0/(4.0*((l9_85+l9_51)-(l9_85*l9_51)))))*l9_85);
l9_76=l9_77;
l9_78++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_90=l9_89<sc_AmbientLightsCount;
if (l9_90)
{
vec3 l9_91;
if (l9_90)
{
l9_91=sc_AmbientLights[l9_89].color;
}
else
{
l9_91=vec3(0.0);
...
if (l9_90)
{
l9_92=sc_AmbientLights[l9_89].intensity;
}
else
{
l9_92=0.0;
}
l9_88=l9_87+(((l9_91*l9_92)/vec3(3.1415901))*l9_39);
l9_87=l9_88;
l9_89++;
continue;
}
...
#endif
vec3 l9_93=mix(l9_63,l9_63*l9_15.xyz,vec3(l9_15.w)).xyz+l9_86;
vec4 l9_94=vec4(l9_93.x,l9_93.y,l9_93.z,vec4(0.0).w);
l9_94.w=1.0-(max(max(l9_39.x,l9_39.y),l9_39.z)*0.15700001);
l9_38=l9_94;
}
#else
{
...
{
vec2 l9_99=N3_getUV(Tweak_N44);
vec2 l9_100;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_CLEARCOAT_TEXTURE_TRANSFORM)
{
l9_100=N3_uvTransform(l9_99,clearcoatTexture_offset,clearcoatTexture_scale,clearcoatTexture_rotation);
}
#else
{
l9_100=l9_99;
...
#endif
float l9_102=l9_98*clearcoatFactor;
float l9_103;
#if (ENABLE_CLEARCOAT_ROUGHNESS_TEX)
{
vec2 l9_104=N3_getUV(Tweak_N60);
vec2 l9_105;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_CLEARCOAT_ROUGHNESS_TEXTURE_TRANSFORM)
{
l9_105=N3_uvTransform(l9_104,clearcoatRoughnessTexture_offset,clearcoatRoughnessTexture_scale,clearcoatRoughnessTexture_rotation);
}
#else
{
l9_105=l9_104;
...
#endif
l9_103=ssSRGB_to_Linear(sc_SampleTextureBiasOrLevel(clearcoatRoughnessTextureDims.xy,clearcoatRoughnessTextureLayout,l9_106,l9_105,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture),(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureBorderColor,0.0,clearcoatRoughnessTexture).y);
}
#else
{
l9_103=1.0;
...
#endif
float l9_107=l9_103*clearcoatRoughnessFactor;
vec3 l9_108;
#if (ENABLE_CLEARCOAT_NORMAL_TEX)
{
vec2 l9_109=N3_getUV(Tweak_N47);
vec2 l9_110;
#if (ENABLE_TEXTURE_TRANSFORM&&ENABLE_CLEARCOAT_NORMAL_TEXTURE_TRANSFORM)
{
l9_110=N3_uvTransform(l9_109,clearcoatNormalTexture_offset,clearcoatNormalTexture_scale,clearcoatNormalTexture_rotation);
}
#else
{
l9_110=l9_109;
...
#endif
l9_108=sc_SampleTextureBiasOrLevel(clearcoatNormalTextureDims.xy,clearcoatNormalTextureLayout,l9_111,l9_110,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture),(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0),clearcoatNormalTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0),clearcoatNormalTextureBorderColor,0.0,clearcoatNormalTexture).xyz*0.9921875;
}
#else
{
l9_108=vec3(0.0,0.0,1.0);
}
#endif
l9_97=l9_107;
l9_96=l9_108;
...
#else
{
l9_112=Globals.BumpedNormal;
}
#endif
float l9_113=clamp(l9_36,0.0,1.0);
ngsAlphaTest(l9_113);
vec3 l9_114=max(l9_35,vec3(0.0));
vec4 l9_115;
#if (sc_ProjectiveShadowsCaster)
{
l9_115=vec4(l9_114,l9_113);
}
#else
{
l9_115=ngsCalculateLighting(l9_114,l9_113,l9_112,Globals.PositionWS,Globals.ViewDirWS,max(l9_37,vec3(0.0)),clamp(l9_14,0.0,1.0),clamp(l9_16,0.0,1.0),clamp(l9_15.xyz,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
vec4 l9_116=max(l9_115,vec4(0.0));
vec3 l9_117;
#if (!sc_ProjectiveShadowsCaster)
{
l9_117=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_96;
}
#else
{
l9_117=Globals.BumpedNormal;
}
#endif
ngsAlphaTest(1.0);
vec4 l9_118;
#if (sc_ProjectiveShadowsCaster)
{
l9_118=vec4(0.0,0.0,0.0,1.0);
}
#else
{
l9_118=ngsCalculateLighting(vec3(0.0),1.0,l9_117,Globals.PositionWS,Globals.ViewDirWS,vec3(0.0),0.0,clamp(l9_97,0.0,1.0),vec3(1.0),vec3(1.0));
}
#endif
vec4 l9_119=max(l9_118,vec4(0.0));
tempGlobals=Globals;
vec4 l9_120;
#if ((ENABLE_SHEEN||ENABLE_TRANSMISSION)||ENABLE_CLEARCOAT)
{
vec4 l9_121=ssSRGB_to_Linear(l9_116);
vec4 l9_122;
#if (ENABLE_SHEEN)
{
vec3 l9_123=(l9_121.xyz*l9_38.w)+l9_38.xyz;
l9_122=vec4(l9_123.x,l9_123.y,l9_123.z,l9_121.w);
}
#else
{
l9_122=l9_121;
...
#if (ENABLE_TRANSMISSION)
{
vec4 l9_125=mix(vec4(l9_25,1.0),l9_122,vec4(ssSRGB_to_Linear(l9_36)));
l9_125.w=1.0;
l9_124=l9_125;
}
#else
...
#if (ENABLE_CLEARCOAT)
{
vec3 l9_127=l9_124.xyz+(ssSRGB_to_Linear(l9_119)*l9_95).xyz;
l9_126=vec4(l9_127.x,l9_127.y,l9_127.z,l9_124.w);
}
#else
{
l9_126=l9_124;
...
#endif
l9_120=ssLinear_to_SRGB(l9_126);
}
#else
{
l9_120=l9_116;
...
if (l9_55==0)
{
l9_58=texture2D(sc_OITAlpha0,l9_44);
l9_57=texture2D(sc_OITDepthLow0,l9_44);
l9_56=texture2D(sc_OITDepthHigh0,l9_44);
}
else
{
l9_58=l9_51;
...
if (l9_55==1)
{
l9_54=texture2D(sc_OITAlpha1,l9_44);
l9_53=texture2D(sc_OITDepthLow1,l9_44);
l9_52=texture2D(sc_OITDepthHigh1,l9_44);
}
else
{
l9_54=l9_58;
...
l9_59[6]=l9_45[6];
l9_59[7]=l9_45[7];
unpackValues(l9_52.w,l9_55,l9_59);
unpackValues(l9_52.z,l9_55,l9_59);
unpackValues(l9_52.y,l9_55,l9_59);
unpackValues(l9_52.x,l9_55,l9_59);
unpackValues(l9_53.w,l9_55,l9_59);
unpackValues(l9_53.z,l9_55,l9_59);
unpackValues(l9_53.y,l9_55,l9_59);
unpackValues(l9_53.x,l9_55,l9_59);
int l9_68[8];
l9_68[0]=l9_46[0];
l9_68[1]=l9_46[1];
l9_68[2]=l9_46[2];
...
l9_68[6]=l9_46[6];
l9_68[7]=l9_46[7];
unpackValues(l9_54.w,l9_55,l9_68);
unpackValues(l9_54.z,l9_55,l9_68);
unpackValues(l9_54.y,l9_55,l9_68);
unpackValues(l9_54.x,l9_55,l9_68);
}
l9_51=l9_54;
l9_50=l9_53;
l9_49=l9_52;
...
mediump vec4 l9_73=texture2D(sc_OITFilteredDepthBoundsTexture,l9_44);
vec2 l9_74=l9_73.xy;
int l9_75;
#if (sc_SkinBonesCount>0)
{
...
if (l9_83)
{
vec3 l9_84=l9_77.xyz*(1.0-(float(l9_46[l9_79])/255.0));
